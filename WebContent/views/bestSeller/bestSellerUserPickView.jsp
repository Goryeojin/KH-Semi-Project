...
<%
  ArrayList<BestSeller> list = (ArrayList<BestSeller>)session.getAttribute("list1");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>유저픽 베스트셀러</title>
    <style>
        body { margin: 0;}
        div{
        ...
        <div id="content">
          <div id="content_3">
				  <div id="pageCategory_bar">
      				  <a href="">🏠︎ HOME </a> > 베스트셀러 > readMe 독자들이 뽑은 베스트셀러
   					 </div>
			</div>
	...
	<!--  
            <div id="bookbook2">
                ...
                <div id="ranking">
                  ...
                  <div id="rankingvote">
                    <div id="rankingvoteText">👍1504</div>
                    <div id="ddabong"></div>
                  </div>

                  <div id="book">
                     <div id="bookimg">
                        <img src="../../resources/view_img/자기계발01_성공하는 사람들의 7가지 습관.jpg" alt="">
                    </div>
            ...
            <div id="bookbook3">
                ...
                <div id="ranking">
                  ...
                  <div id="book">
                     <div id="bookimg">
                        <img src="../../resources/view_img/뼈해장국.jpg" alt="">
                    </div>
