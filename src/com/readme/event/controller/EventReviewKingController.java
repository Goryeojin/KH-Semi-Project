...
/**
 * Servlet implementation class EventReviewKingController
 */
@WebServlet("/review.ev")
public class EventReviewKingController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EventReviewKingController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // *listCount : 총 게시글 갯수
        listCount = new EventService().selectReviewCountList();
		...
		ArrayList<Event> list = new EventService().selectMemberReviewCount();
		
		request.getSession().setAttribute("list", list);
		request.getSession().setAttribute("pi", pi);
		
		request.getRequestDispatcher("views/event/eventReviewKingView.jsp").forward(request, response);
	}
