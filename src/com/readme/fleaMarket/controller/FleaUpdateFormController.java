...
/**
 * Servlet implementation class FleaUpdateFormController
 */
@WebServlet("/updateForm.fl")
public class FleaUpdateFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FleaUpdateFormController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/fleaMarket/fleaUpdateForm.jsp").forward(request, response);
