...
public class AdminService {
	...
	//flea 이미지 삭제
	public int deleteFleaImg(String[] fleaNo) {
				
			Connection conn = getConnection();
				
			int result2 = new AdminDao().deleteFleaImg(conn, fleaNo);
...
//		----------- 회원관리 -----------------
	...
	//메인페이지 미답변 문의 조회
		...
		public ArrayList<Request> selectMainRequestList() {
		
			Connection conn = getConnection();
			
			ArrayList<Request> list = new AdminDao().selectMainRequestList(conn);
