...
/**
 * Servlet implementation class AdminEditorOutController
 */
@WebServlet("/EditorN.ad")
public class AdminEditorOutController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminEditorOutController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new AdminService().AdminEditorOut(bookNo);
