...
/**
 * Servlet implementation class AdminUserBoardFleaController
 */
@WebServlet("/userBoardFlea.ad")
public class AdminUserBoardFleaController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUserBoardFleaController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//쿼리스트링으로 요청
				...
				//listCount : 총 게시글 개수
				listCount = new AdminService().selectFleaListCount();
				...
				//4)Service단으로 토스
				ArrayList<FleaAd> list = new AdminService().AdminUserBoardFleaSelect(pi);
		...
		request.getRequestDispatcher("views/admin/adminUserBoardFlea.jsp").forward(request, response);
	}
