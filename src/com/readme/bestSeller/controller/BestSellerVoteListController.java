...
/**
 * Servlet implementation class BestSellerVoteList
 */
@WebServlet("/userVote.be")
public class BestSellerVoteListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BestSellerVoteListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      // *listCount : 총 게시글 갯수
	      listCount = new BestSellerService().selectListCount();
		  ...
		  ArrayList<BestSeller> list = new BestSellerService().selectBestSellerVoteList(pi);
		   
		 
		  
		  request.getSession().setAttribute("VoteList", list);
		  
		  
		  
		  
		  request.getSession().setAttribute("pi", pi);
//	      response.sendRedirect(request.getContextPath() + "/views/bestSeller/bestSellerVoteView.jsp");
