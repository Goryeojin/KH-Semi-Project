...
/**
 * Servlet implementation class myPageBookRequestListController
 */
@WebServlet("/requestList.me")
public class MemberMyPageBookRequestListController extends HttpServlet {
   private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberMyPageBookRequestListController() {
        super();
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      int listCount; // 현재 일반게시판의 게시글 총 갯수=> BOARD테이블로부터 조회 COUNT(*)활용
         ...
         ArrayList<Request> list = new MemberService().selectRequestList(pi, userNo);
      ...
      request.getRequestDispatcher("views/member/myPageBookRequestView.jsp").forward(request, response);
   }
