...
/**
 * Servlet implementation class MemberMyPageInquiryController
 */
@WebServlet("/inquiryForm.me")
public class MemberMyPageInquiryFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
	public MemberMyPageInquiryFormController() {
        super();
